...
class DateArithmetic
{
    static void Main()
    {
        ...
        if (DateTime.TryParse(input, out enteredDate))
        {
            ...
            Console.WriteLine("\nDate Calculations:");
            Console.WriteLine("Entered Date     : " + enteredDate.ToString("yyyy-MM-dd"));
            Console.WriteLine("After Adding: ");
            Console.WriteLine("  - 7 Days      : " + enteredDate.AddDays(7).ToString("yyyy-MM-dd"));
            Console.WriteLine("  - 1 Month     : " + enteredDate.AddDays(7).AddMonths(1).ToString("yyyy-MM-dd"));
            Console.WriteLine("  - 2 Years     : " + newDate.ToString("yyyy-MM-dd"));
