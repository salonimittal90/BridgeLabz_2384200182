...
class Question10
{
    // Method to calculate the slope between two points (x1, y1) and (x2, y2)
    ...
    static void Main()
    {
        ...
        {
            Console.WriteLine("The points are NOT collinear by slope method.");
        }
        ...
        {
            Console.WriteLine("The points are NOT collinear by area method.");
        }
    }
}
